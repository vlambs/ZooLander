...
namespace ZooBusiness.Animalerie
{
    public class Vipere : Reptiles
    {
        ...
        public void Reproduction(Vipere e2)
        {
        ...
        {
            // Ajout d'un elephant
            listeViperes.Add(new Vipere(pere, mere));
        }
        ...
        public override void Reproduction(AAnimal a2)
        {
            if (this.Equals(a2))
                ...
                this.Reproduction((Vipere)a2);
        }

        public Vipere(string pere, string mere)
        {
            this.pere = pere;
            this.mere = mere;
            Random rnd = new Random();
            ...
            this.taille = rnd.Next(8, 15);
            this.pattes = 0;
            this.niveauFaim = 3;
        }
        public Vipere(string nom, string sexe, int age, int poids, int taille)
        {
            this.nom = nom;
            this.sexe = sexe;
            this.age = age;
